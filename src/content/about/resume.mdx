...
A generalist Software Engineer, specialized in solutions and product engineering,
utilizing technologies across the stack and languages like Javascript (Next.js), Python (Django), and GoLang (Cobra).
Based in San Bernardino, California USA with remote and open source experience.
...
## Web Dev Challenge: What can you build in 4 hours with Google Gemini?
