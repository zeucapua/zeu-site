...
## Software Engineer, Roomy [<Icon name="tabler:external-link" class="inline-block" />](https://roomy.space)
_January 2025 - April 2025_
- A decentralized group chat platform built on top of the AT Protocol social network, engineered for peer to peer
local first communication, with a familiar yet unique user experience to Discord
- Implemented real time stores using CRDTs, extended chat features like at (@) mentions
- Did marketing via social media and speak at the ATmosphere Conference about the application
- Technology Stack: Svelte, Automerge, AT Protocol, TailwindCSS, TipTap
<a href="https://roomy.space" class="flex gap-2 items-center -my-8 hover:underline" target="_blank">
  <img src="/roomy.png" alt="Roomy Logo" class="size-8 rounded" />
  roomy.space
  <Icon name="tabler:external-link" class="inline-block -top-2" />
</a>
...
## Software Engineering Consultant, Paper Compute Company [<Icon name="tabler:external-link" class="inline-block" />](https://papercompute.com)
_March 2026 - May 2026_ 
- Implemented a cloud web platform that allows organization customers to manage their engineer's AI agent usage,
from the prompts written and results generated, to token usage and the total cost.
- Technology Stack: TanStack Start, TanStack Query, React, Typescript
<a href="https://papercompute.com" class="flex gap-2 items-center -my-8 hover:underline" target="_blank">
  <img src="/papercompute.svg" alt="Paper Compute Logo" class="size-8 rounded" />
  papercompute.com
  <Icon name="tabler:external-link" class="inline-block -top-2" />
</a>

## Software Engineering Consultant, Zuplo [<Icon name="tabler:external-link" class="inline-block" />](https://zuplo.com)
